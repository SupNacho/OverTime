...
public class FbChooseCompanyRepository implements IChooseCompanyRepository {

    private List<CompanyEntity> companies;
    private IUserCompanyRepository userCompanyRepository;
    private ICompanyRepository companyRepository;

    public FbChooseCompanyRepository(IUserCompanyRepository userCompanyRepository, ICompanyRepository companyRepository) {
